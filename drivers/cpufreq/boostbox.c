...
// global perf bias (don't change!)
static int dsb_energy_bias = 0;
module_param(dsb_energy_bias, uint, 0644);
// resets don't need user tunables
static int dsb_reset_rt = 15;
// reset to zero - covers most cases
static int dsb_reset_zero = 0;
...
static void unboost_all_cpus(struct boost_drv *b)
{
	...
	do_stune_unboost("top-app", dsb_reset_zero);
	do_stune_unboost("foreground", dsb_reset_zero);
	do_stune_unboost("gfx", dsb_reset_zero);
	do_stune_unboost("rt", dsb_reset_rt);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
...
void dsb_audio_unboost_kick(void)
{
	struct boost_drv *b = boost_drv_g;
	...
	unsigned int duration_ms)
{
	...
	do_stune_boost("top-app", dsb_kick_max_boost - dsb_energy_bias);
	do_stune_boost("foreground", dsb_fg_boost - dsb_energy_bias);
	do_stune_boost("rt", dsb_rt_boost - dsb_energy_bias);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
...
#ifdef CONFIG_DYNAMIC_STUNE_BOOST
	/* Set dynamic stune boost value */
	do_stune_boost("top-app", dsb_top_app_boost - dsb_energy_bias);
	do_stune_boost("gfx", dsb_gfx_kick_boost - dsb_energy_bias);
	do_stune_boost("rt", dsb_rt_boost - dsb_energy_bias);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
...
#ifdef CONFIG_DYNAMIC_STUNE_BOOST
	/* Set dynamic stune boost value */
	do_stune_boost("audio", dsb_audio_boost - dsb_energy_bias);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
...
#ifdef CONFIG_DYNAMIC_STUNE_BOOST
	/* Set dynamic stune boost value */
	do_stune_unboost("audio", dsb_reset_zero);
#endif /* CONFIG_DYNAMIC_STUNE_BOOST */
